...
public class UserRequest implements Callback<UserToken> {
    private View view;
    private ProgressBar progressBar;
    private Context context;

    public UserRequest(View view, Context context, ProgressBar progressBar) {
        this.view = view;
    ...
    public void onResponse(@NonNull Call<UserToken> call, @NonNull Response<UserToken> response) {
        ...
        if (statusCode == 201) {
            ...
            Snackbar.make(view, context.getString(R.string.wrong_data), Snackbar.LENGTH_SHORT).show();
        }
    }
